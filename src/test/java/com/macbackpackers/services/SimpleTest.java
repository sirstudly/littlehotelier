...
public class SimpleTest {
    ...
    public void testJsonCloudbeds() throws Exception {
        ...
        Assert.assertEquals( "5f32c1261f6b40.80921016", rootElem.get( "guarantee" ).getAsString() );
